...
const translations: TranslationDict = {
  ...
  'paso1.cascoAntiguo': { es: 'Soluciones casco antiguo', en: 'Old town solutions', de: 'Altstadt-Lösungen', it: 'Soluzioni centro storico', hu: 'Óvárosi megoldások' },
  'paso1.cascoAntiguo.desc': { es: 'Instalación sin unidades exteriores en fachada para cascos antiguos', en: 'Installation without outdoor units in facade for old buildings', de: 'Installation ohne Außeneinheiten in der Fassade für alte Gebäude', it: 'Installazione senza unità esterne in facciata per edifici storici', hu: 'Telepítés kültéri egységek nélkül régi épületekhez' },
  ...
  'tipo.cassette': { es: 'Cassette', en: 'Cassette', de: 'Kassette', it: 'Cassetta', hu: 'Kazetta' },
  'tipo.cassette.badge': { es: '1 estancia', en: '1 room', de: '1 Raum', it: '1 stanza', hu: '1 szoba' },
  'tipo.cassette.desc': { es: 'Instalada en techo o pared', en: 'Installed in ceiling or wall', de: 'In Decke oder Wand eingebaut', it: 'Installato in soffitto o parete', hu: 'Mennyezetbe vagy falba szerelve' },
  ...
  'tipo.multi-cassette': { es: 'Multicassette', en: 'Multi Cassette', de: 'Multi Kassette', it: 'Multi Cassetta', hu: 'Multi kazetta' },
  'tipo.multi-cassette.badge': { es: '2-4 estancias', en: '2-4 rooms', de: '2-4 Räume', it: '2-4 stanze', hu: '2-4 szoba' },
  'tipo.multi-cassette.desc': { es: 'Múltiples unidades cassette', en: 'Multiple cassette units', de: 'Mehrere Kassetteneinheiten', it: 'Più unità cassetta', hu: 'Több kazetta egység' },

...
const translations: TranslationDict = {
  ...
  'paso1.averia': { es: 'Localizar Avería', en: 'Find Malfunction', de: 'Fehler finden', it: 'Trovare il malfunzionamento', hu: 'Meghibásodás keresése' },
  'paso1.averia.desc': { es: 'Reparación de aire acondicionado en Mallorca', en: 'Air conditioning repair in Mallorca', de: 'Klimaanlage Reparatur auf Mallorca', it: 'Riparazione del condizionatore a Maiorca', hu: 'Légkondicionáló javítás Mallorcán' },
  'paso1.proyecto': { es: 'Subir Proyecto', en: 'Upload Project', de: 'Projekt hochladen', it: 'Carica progetto', hu: 'Projekt feltöltése' },
